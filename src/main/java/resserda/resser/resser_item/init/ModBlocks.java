...
public class ModBlocks {
    ...
    public static final OreBlock SOUL_ORE = new OreBlock(FabricBlockSettings.of(Material.STONE).breakByTool(FabricToolTags.PICKAXES, 3).requiresTool().strength(3.0f, 3.0f));
